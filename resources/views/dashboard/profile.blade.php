...
@section('content')
    ...
    <span><strong>Nascimento: </strong></span> <span>{{ \Carbon\Carbon::parse($user->date_birth)->format('d/m/Y') . ' - ' . date('Y') - \Carbon\Carbon::parse($user->date_birth)->format('Y') . ' anos' }}</span><br>
