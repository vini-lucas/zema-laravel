        ...
        <tbody>
            @forelse ($enterprises as $enterprise)
                <tr>
                    ...
                    <td style="display: flex;"><a href="{{ route('enterprises.show', ['enterprise' => $enterprise->id]) }}">Vizualizar</a> - <a href="{{ route('users.edit', ['user' => $enterprise->id]) }}">Editar</a> - 
                        <form action="{{ route('users.destroy', ['user' => $enterprise->id]) }}" method="POST">
                            @csrf
                            @method('delete')
