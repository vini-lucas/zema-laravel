...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('inss', function (Blueprint $table) {
            $table->foreignId('enterprise_id') // Nome da coluna com a chave estrangeira
                ->after('user_id') // Coluna onde a chave estrangeira ficará logo após
                ->constrained('enterprises') // Nome da coluna pai (onde a chave estrangeira retira informação)
